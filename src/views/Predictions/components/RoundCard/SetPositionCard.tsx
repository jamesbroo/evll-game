...
import { useCake, usePredictionsContract } from 'hooks/useContract'
import useTokenBalance, { useEVLLllowance, useGetBnbBalance } from 'hooks/useTokenBalance'
...
import { getCakeContract, getPredictionsContract } from 'utils/contractHelpers'
...
const SetPositionCard: React.FC<SetPositionCardProps> = ({ position, togglePosition, epoch, onBack, onSuccess }) => {
  ...
  const { isApproving, isApproved, isConfirmed, isConfirming, handleApprove, handleConfirm } =
    useApproveConfirmTransaction({
      ...
      onApprove: () => {
        console.log('debug approve', cakeContract, predictionContract)
        return callWithGasPrice(cakeContract, 'approve', [predictionContract.address, ethers.constants.MaxUint256])
      },
      onConfirm: () => {
        return callWithGasPrice(cakeContract, 'approve', [predictionContract.address, ethers.constants.MaxUint256])
      },
  ...
  const currentAllowance = useEVLLllowance()
