...
import { useGetPredictionsStatus, useIsChartPaneOpen, useIsHistoryPaneOpen } from 'state/predictionsEUR/hooks'
import { setChartPaneState } from 'state/predictionsEUR'
      ...
      <StyledDesktop>
        <SplitWrapper ref={splitWrapperRef}>
          ...
          <Gutter ref={gutterRef}>
            <TradingViewLabel justifyContent="flex-end" symbol="EURUSD" />
          </Gutter>
