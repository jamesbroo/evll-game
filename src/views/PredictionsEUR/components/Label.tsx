...
import { ROUND_BUFFER } from 'state/predictionsEUR/config'
import { formatBigNumberToFixed } from 'utils/formatBalance'
import { useGetCurrentRoundLockTimestamp, useGetLastOraclePrice } from 'state/predictionsEUR/hooks'
  ...
  return (
    <Box pl="24px" position="relative" display="inline-block">
      <Token left={0}>
        ...
        <img src={EUR} alt="eur-logo" width='60px' height="60px" />
      </Token>
      <Label dir="left">
